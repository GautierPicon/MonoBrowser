...
- `src/monobrowser/tab_page.py`: `TabPage` = thin `QWebEngineView` wrapper. All tabs are created through `SimpleBrowser._open_tab`, the single site that wires signals and the popup factory.
